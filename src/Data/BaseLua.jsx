...
MetaUpgradeCardData = 
{
	...
	CastCount = -- Eternity, Chronos
	{
		...
		{
			{ CardUpgradePoints = 2 },
			{ CardUpgradePoints = 3, MixerIBoss = 1 },
		},
	...
	SprintShield = -- Swift Runner, Achilles
	{
		...
		{
			{ CardUpgradePoints = 1, },
			{ CardUpgradePoints = 3, MixerOBoss = 1 },
		},
	...
	StatusVulnerability = -- Origination, Chaos
	{
		...
		{
			{ CardUpgradePoints = 5 },
			{ CardUpgradePoints = 10, PlantChaosThalamus = 4, },
		},
	...
	StartingGold = -- Boatman, Charon
	{
		...
		{
			{ CardUpgradePoints = 5 },
			{ CardUpgradePoints = 10, MixerIBoss = 1 },
		},
	...
	EpicRarityBoost = -- Divinity, Zeus & Hera
	{
		...
		{
			{ CardUpgradePoints = 4 },
			{ CardUpgradePoints = 8, MixerQBoss = 1, },
		},
	...
	CardDraw = -- Judgment, Hades
	{
		...
		UpgradeResourceCost = 
		{
			...
			{ CardUpgradePoints = 20, MixerQBoss = 2 },
		},
