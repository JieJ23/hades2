        ...
        {loader ? (
          ...
          <div className="w-full max-w-350 mx-auto py-16">
            ...
            <div className="flex gap-2 px-2">
              <select
                className="select select-sm rounded border-0 focus:outline-none focus:border-transparent text-[13px]"
                value={aspect}
                onChange={(e) => {
            ...
            <div className="overflow-x-scroll my-2">
              <table className="table table-xs bg-[#0e0c12]/80 border-separate border-spacing-0.5 rounded font-[Ubuntu]">
                <thead>
            ...
            <div className="flex flex-col md:flex-row gap-2 my-2">
              <div className="w-full overflow-x-scroll">
                <table className="table table-xs border-separate border-spacing-0.5 rounded font-[Ubuntu] bg-[#0e0c12]/80">
                  <thead>
              ...
              <div className="w-full overflow-x-scroll">
                <table className="table table-xs border-separate border-spacing-0.5 rounded bg-[#0e0c12]/80">
                  <thead>
                    <tr className="font-[Ale]">
