  ...
  return (
    <main className="relative">
      ...
      <div className="max-w-[1200px] font-[Source] text-[12px] md:text-[13px] mx-auto">
        <SideNav />
        <div className="my-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-2 p-1">
          {savestates.map((obj, index) => (
            <div
              key={index}
              className="border-1 border-black rounded bg-[#ffffff30] flex flex-col justify-between gap-1 p-1"
            >
              <div className="flex flex-wrap gap-1 text-[11px]">
                <div className="px-2 py-1 bg-[#00ffaa] text-black rounded">{obj.share}</div>
                <div className="px-2 py-1 bg-[#28282b] rounded">{obj.asp}</div>
                <div className="px-2 py-1 bg-[#28282b] rounded">{obj.fam}</div>
                <div className="px-2 py-1 bg-[#28282b] rounded">{obj.loc}</div>
                <div className="px-2 py-1 bg-[#28282b] rounded">{obj.ks}</div>
