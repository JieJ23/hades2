  ...
  return (
    <main className="relative">
      ...
      <div className="max-w-[1200px] font-[Source] text-[12px] md:text-[13px] mx-auto">
        <SideNav />
        <div className="my-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 md:gap-2 p-1 px-2">
          {displayData.map((obj, index) => (
            <div
              key={index}
              className="border-1 border-black rounded bg-[#a3a3a330] flex flex-col justify-between gap-1 gap p-1"
            >
