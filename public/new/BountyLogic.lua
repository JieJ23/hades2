...
function StartPackagedBounty( screen, button )
	...
	StartOver( { RoomName = bountyData.RoomName, StartingBiome = bountyData.StartingBiome, ForcedRewards = bountyData.ForcedRewards, ActiveBounty = bountyData.Name, RunOverrides = bountyData.RunOverrides, StartingRoomOverrides = bountyData.StartingRoomOverrides  } )
